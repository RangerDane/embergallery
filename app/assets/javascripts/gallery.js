...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gallery = __webpack_require__(219);

	var _gallery2 = _interopRequireDefault(_gallery);

	var _dataSlug = __webpack_require__(217);

	var _dataSlug2 = _interopRequireDefault(_dataSlug);
	...
	var routes = _react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    _reactRouter.Route,
	    { path: '/', component: App },
	    _react2.default.createElement(_reactRouter.IndexRoute, { components: { gallery: _gallery2.default, image: _image2.default } }),
	    _react2.default.createElement(_reactRouter.Route, { path: ':gallery/:imageIdx', components: { gallery: _gallery2.default, image: _image2.default } }),
	    _react2.default.createElement(_reactRouter.Route, { path: ':gallery', components: { gallery: _gallery2.default, image: _image2.default } })
	  )
	);

	document.addEventListener("DOMContentLoaded", function () {
	  _reactDom2.default.render(routes, document.getElementById('everything'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var root_imagedir = "http://stargh.com/things/gallery-one/";
	...
	var Image = function (_React$Component) {
	  ...
	  function Image(props) {
	    ...
	    var galleryName = _this.props.params.gallery || "skies";
	    var imageIdx = _this.props.params.imageIdx || 0;
	    var imageSrc = _dataSlug2.default.galleries[galleryName].contents[imageIdx].image;
	  ...
	  _createClass(Image, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      var galleryName = nextProps.params.gallery || "skies";
	      var imageIdx = nextProps.params.imageIdx || 0;
	      var imageSrc = _dataSlug2.default.galleries[galleryName].contents[imageIdx].image;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement('img', { src: root_imagedir + "images/large/" + this.state.imageSrc })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var Data = {
	  ...
	  "galleries": {
	    "skies": {
	      "name": "Skies",
	      "description": "Pictures of the sky",
	      "contents": [{
	        "name": "Photograph",
	        "image": "sky-1.jpg"
	      }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.Data = _dataSlug2.default;
	...
	var Nav = function (_React$Component) {
	  ...
	  _createClass(Nav, [{
	    key: 'render',
	    value: function render() {
	      var keys = Object.keys(_dataSlug2.default.galleries);

	      var links = keys.map(function (name, i) {
	        return _react2.default.createElement(
	          'li',
	          { key: i },
	          _react2.default.createElement(
	            _reactRouter.Link,
	            { to: "/" + name + "/", activeClassName: 'active' },
	            _dataSlug2.default.galleries[name].name
	          )
	        );
	      });
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'h1',
	              null,
	              _dataSlug2.default.name
	            ),
	            _react2.default.createElement(
	              'h2',
	              null,
	              _dataSlug2.default.description
	            )
	          ),
	          _react2.default.createElement(
	            'ul',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Gallery = function (_React$Component) {
	  ...
	  function Gallery(props) {
	    ...
	    var galleryName = _this.props.params.gallery || "skies";
	    var gallery = _dataSlug2.default.galleries[galleryName];
	  ...
	  _createClass(Gallery, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      this.setState({
	        galleryname: nextProps.params.gallery,
	        gallery: _dataSlug2.default.galleries[nextProps.params.gallery]
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var thumbs = this.state.gallery.contents.map(function (content, i) {
	        return _react2.default.createElement(
	          'li',
	          null,
	          _react2.default.createElement(
	            _reactRouter.Link,
	            { to: "/" + _this2.state.galleryname + "/" + i },
	            _react2.default.createElement('img', { src: root_imagedir + "images/thumbnails/" + content.image, key: i })
	          )
	        );
	      });
...
/***/ }
/******/ ]);
//# sourceMappingURL=gallery-one.js.map
